...
| [day05.rs](./src/bin/05.rs) | much code. too much code? never!   |         531.5μs | 127 000 000μs (12.7s) |
| [day06.rs](./src/bin/06.rs) | that was surprisingly painless     | 0.285μs (285ns) |        2500μs (2.5ms) |
| [day07.rs](./src/bin/07.rs) |                                    |                 |                       |
